...
| TO-114 | Production auth and Supabase authority | READY | GLM worker + GPT-6 review | `agent-tasks/003-auth-supabase.md` | — |
| TO-115 | Provider configuration and audit policy | READY | GLM worker + GPT-6 review | `agent-tasks/004-provider-config.md` | — |
| TO-116 | Core workflow verification and repair | READY | GLM worker + GPT-6 review | `agent-tasks/005-core-workflows.md` | — |
...
| TO-119 | Final production gates and launch handoff | BLOCKED_BY_TO114_TO118 | GPT-6 | `agent-tasks/008-final-production-gates.md` | — |
