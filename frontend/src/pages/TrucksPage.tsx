  ...
  return (
    <div className="p-4 space-y-6 pb-8">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Truck Types</h1>
      </div>
          ...
          {filteredTrucks.map((truck) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">{truck.category}</p>
                  </div>
                </div>
              ...
              <div className="mt-4 grid grid-cols-3 gap-2">
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 p-2 rounded-lg text-center">
                  <p className="text-[10px] uppercase text-slate-400 font-bold">Max Weight</p>
                  <p className="text-sm font-medium">{truck.max_weight}kg</p>
                </div>
                <div className="bg-slate-50 dark:bg-slate-900/50 p-2 rounded-lg text-center">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-800 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-scale-in">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Truck Name</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Max Weight (kg)</label>
                  <input
                    type="number"
