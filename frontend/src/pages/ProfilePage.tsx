    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="mx-auto max-w-7xl space-y-6 px-4 pb-8 pt-4 md:px-8 md:pb-10 md:pt-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-primary-600/80">Account Center</p>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-500 dark:text-slate-400 md:text-base">
              Manage your identity, company records, notification preferences, and linked services from one place.
            </p>
          </div>
          <div className="inline-flex items-center gap-3 self-start rounded-2xl border border-emerald-100 bg-white px-4 py-3 text-sm shadow-sm dark:border-emerald-900/40 dark:bg-slate-800">
            ...
            <div>
              <p className="font-semibold text-slate-900 dark:text-white">{t.verifiedAccount}</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Profile security and settings are in sync.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
          <div className="space-y-6 xl:sticky xl:top-24 xl:self-start">
            ...
            <div className="card p-4 space-y-3">
              ...
              <div className="rounded-2xl bg-slate-50 px-3 py-2 text-xs text-slate-500 dark:bg-slate-800/70 dark:text-slate-400">
                Changes here sync with your current account metadata and linked workspace settings.
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card divide-y divide-slate-100 dark:divide-slate-700">
              ...
              <div className="grid gap-0 md:grid-cols-2">
                ...
                <div className="p-4 flex items-center gap-3 border-t border-slate-100 dark:border-slate-700 md:border-l md:border-t-0">
                ...
                {user?.login_id && (
                  <div className="p-4 flex items-center gap-3 border-t border-slate-100 dark:border-slate-700">
                ...
                <div className={`p-4 flex items-center gap-3 border-t border-slate-100 dark:border-slate-700 ${user?.login_id ? 'md:border-l' : ''}`}>
            ...
            <div className="card divide-y divide-slate-100 dark:divide-slate-700">
              ...
              {!isEditingCompany && (
                <div className="grid gap-0 md:grid-cols-2">
                  ...
                  <div className="p-4 flex items-center gap-3 border-t border-slate-100 dark:border-slate-700 md:border-l">
              ...
              {Object.entries(notifications).map(([key, value]) => (
                <div key={key} className="p-4 flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{t.notificationDesc}</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
