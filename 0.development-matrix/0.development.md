...
├── 0.development.md .......... [YOU ARE HERE] Development rules
...
System dependency map (NEW)

File → File dependencies

Database table relationships

API endpoint → Page mappings

Service → Service dependencies

Must be consulted BEFORE making changes

skills.md

Learnings and error patterns (NEW)
...
Anti-patterns and violations to avoid (NEW)

Timeless lessons from past mistakes

Severity-categorized rules

Must be checked BEFORE and AFTER changes
