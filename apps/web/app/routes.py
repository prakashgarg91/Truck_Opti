...
try:
    from app.advanced_3d_packer_v2 import create_enterprise_packing_recommendation
        ...
        for truck in trucks_to_test:
            try:
                ...
                if pack_results:
                    ...
                    cost_details = (
                        f"Cost breakdown → Fuel: ₹{fuel_cost:.0f}, Driver: ₹{driver_cost:.0f}, "
                        f"Maintenance: ₹{maintenance_cost:.0f}, Toll: ₹{toll_cost:.0f}"
                    )
                    reason = f"{reason} | {cost_details}"
