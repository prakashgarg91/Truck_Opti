...
class PackingAI:
    ...
    def predict_optimal_truck_type(self, cartons: Dict, historical_data: List = None) -> List[TruckRecommendation]:
        ...
        for truck in available_trucks:
            ...
            density_factor = 0.9 if density > 0 else 0.7
            confidence = sum(confidence_factors + [density_factor]) / (len(confidence_factors) + 1)
            ...
            if density > 0.4:
                reasoning.append("High-density cargo detected; prioritize weight capacity")
