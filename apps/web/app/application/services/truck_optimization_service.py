...
from ...services.base import ServiceResult, TransactionalService
from ...domain.entities import TruckEntity, CartonEntity, PackingJobEntity
from ...domain.value_objects import OptimizationStrategy, Dimensions, Weight
