# TO-HYG-009 — Audit and retire obsolete embedded G2G development tooling
...
4. Preserve real UX/telemetry capability by moving it into normal product modules with clear ownership; do not preserve an autonomous coding framework merely because product code imports it.
...
- Write `agent-results/009-result.md` with classification, changes, commands and evidence.
