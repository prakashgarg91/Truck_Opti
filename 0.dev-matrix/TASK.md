...
| T-131 | Reconcile GitHub Dependabot alert count with local audits | P1 | 🔐 Security | ✅ DONE — Alert #69 fixed: `PyPDF2==3.0.1` → `pypdf>=3.17.0` in `apps/web/requirements.txt`, pip_audit exit 0, committed `ce9d4c28` pushed 2026-04-12 |
