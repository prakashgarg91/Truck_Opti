...
> **Evidence:** `cd frontend && npm run build` passed on 2026-04-05; `npm run test:packing` passed 5/5 deterministic checks on 2026-04-05; the last stable `npm run test:frontend-smoke` result remains 16/17 from 2026-04-03 because a 2026-04-05 rerun timed out on `/login` from the current manager environment; `npm run test:prod-config` passed 2/6 on 2026-04-05.
